...
def hangman():
    ...
    secret_words = ['MINECRAFT', 'ENDERMAN', 'DIAMONDS', 'GRASSBLOCK', 
                    'ZOMBIE','ENDERDRAGON', 'HEROBRINE', 'STEVE',      
                    'GOLDENAPPLE', 'WOOD', 'PIGS','COWS', 'BEDS', 'PICKAXE',
                    'GOLD', 'IRON', 'HOUSE', 'SWORD', 'SKELETON', 'CHICKEN', 
                    'BLOCKS', 'CREEPER', 'ENCHANTMENT', 'ENDERWORLD',
                    'NETHERWORLD', 'VILLAGER', 'NOTCH', 'DANTDM', 'WORLD']     
    ...
    lives = 5 #number of lives you have
...
If you run out of attempts, then you lose!'''
    ...
    print ''
    print 'WOW! ' + name + ' is a nice name'
    print ''
    
    while lives > 0 and hidden_letters != picked_word: #holds entire game and 
        ...
        while guess not in alphabet: #If input is not a letter or 
                                   #more than 1 letter this while loop runs
    ...
    elif lives <= 0: #you lose
        print "BOO! You Lost. The word was " + picked_word
